...
export const TEXT: { [k: number]: HexText } = {
  1: {
    title: "1. Ch'ien / The Creative ䷀",
    text: (
      <>
        The first hexagram is made up of six unbroken lines. These unbroken
        lines stand for the primal power, which is lightgiving, active, strong,
        ...
        “sublime” means literally “head,” “origin,” “great.” This is why K'ung
        Fu-tzu says in explaining it: “Great indeed is the generating power of
        the Creative; all beings owe their beginning to it. This power permeates
        ...
        to notable success: “Because he sees with great clarity causes and
        ...
        To the attribute success are linked the mores, which regulate and
        organize the expressions of love and thereby make them successful. The
        ...
        that which is due him and which constitutes his happiness. The attribute
        perseverance is correlated with wisdom, which discerns the immutable
        laws of all that happens and can therefore bring about enduring
        conditions. These speculations, already broached in the commentary
        called Wên Yen,] later formed the bridge connecting the philosophy of
        the “five stages (elements) of change,” as laid down in the Book of
        ...
        course of time this combination of the two systems of thought opened the
        way for an increasingly intricate number symbolism.
        <br />
        <p>
          <br />
          &nbsp;&nbsp;&nbsp;&nbsp;THE IMAGE
    ...
    lines: [
      ...
      <>
        ...
        from the others is his seriousness of purpose, his unqualified
      ...
      <>
        ...
        the holy sage who seeks seclusion. There is no general law to say which
        of the two is the right way. Each one in this situation must make a free
      ...
      <>
        ...
        Everyone who sees him may count himself blessed. K'ung Fu-tzu says about
        this line:
        <br />
        <br />
      ...
      <>
        ...
        motion and changes into the hexagram K’un, THE RECEPTIVE, whose
        character is devotion. The strength of the Creative and the mildness of
  ...
  2: {
    ...
    text: (
      <>
        ...
        the Receptive does not combat the Creative but completes it. It
        ...
        Here, however, the perseverance is more closely defined: it is that of a
        mare. The Receptive connotes spatial reality in contrast to the
        ...
        hexagram indicates is action in conformity with the situation. The
        ...
        task to try to lead-that would only make him lose the way-but to let
        himself be led. If he knows how to meet fate with an attitude of
        ...
        set. The time of toil and effort is indicated by the west and the south,
        for west and south symbolize the place where the Receptive works for the
        Creative, as nature does in summer and autumn. If in that situation one
        does not mobilize all one’s powers, the work to be accomplished will not
        be done. Hence to find friends there means to find guidance. But in
        addition to the time of toil and effort, there is also a time of
        planning, and for this we need solitude. The east symbolizes the place
        where a man receives orders from his master, and the north the place
        where he reports on what he has done. At that time he must be alone and
        objective. In this sacred hour he must do without companions, so that
        the purity of the moment may not be spoiled by factional hates and
        favoritism.
        <br />
        <p>
          <br />
    ...
    lines: [
      ...
      <>
        ...
        line and in turn form solid bodies. In mathematics, when we discriminate
        between lines, planes, and solids, we find that rectangular planes
        result from straight lines, and cubic magnitudes from rectangular
        ...
        is calm and still: this is its foursquareness. It tolerates all
        creatures equally: this is its greatness. Therefore it attains what is
      ...
      <>
        ...
        decorated—the symbol of aristocratic reserve. When anyone is called upon
        to work in a prominent but not independent position, true success
      ...
      <>
        ...
        that symbolizes the inflation of the earth principle. Midnight blue is
        the color of heaven; yellow is the color of the earth. Therefore, when
        black and yellow blood flow, it is a sign that in this unnatural contest
  ...
  3: {
    ...
    text: (
      <>
        ...
        heaven and earth bring forth individual beings. It is their first
        meeting, which is beset with difficulties. The lower trigram Chên is the
        Arousing; its motion is upward and its image is thunder. The upper
  ...
  4: {
    ...
    text: (
      <>
        ...
        <br />
        <br />
        Given in addition a perseverance that never slackens until the points
        are mastered one by one, real success is sure to follow. Thus the
    ...
    lines: [
      ...
      <>
        ...
        superiority and strength that enable him to tolerate with kindliness the
      ...
      <>
        ...
        own individuality when he slavishly imitates a strong personality of
        higher station. He is like a girl throwing herself away when she meets a
        strong man. Such a servile approach should not be encouraged, because it
        is bad both for the youth and the teacher. A girl owes it to her dignity
        to wait until she is wooed. In both cases it is undignified to offer
      ...
      <>
        ...
        subordinates himself to his teacher will certainly be helped.
      </>,
      <>
        <p className="smallCaps">
          &nbsp;&nbsp;&nbsp;&nbsp;Nine at the top means:
  ...
  5: {
    ...
    text: (
      <>
        ...
        danger in front. Strength in the face of danger does not plunge ahead
        but bides its time, whereas weakness in the face of danger grows
        ...
        nothing to do but to wait until the rain falls. It is the same in life
        when destiny is at work. We should not worry and seek to shape the
  ...
  6: {
    ...
    text: (
      <>
        ...
        Thus the two halves move away from each other, giving rise to the idea
        of conflict.
        <br />
        <br />
        ...
        bitter end has evil effects even when one is in the right, because the
        ...
        require concerted unity of forces. Conflict within weakens the power to
    ...
    lines: [
      ...
      <>
        ...
        contested, but since it is really one’s own, one cannot be robbed of it.
        Whatever a man possesses through the strength of his own nature cannot
  ...
  7: {
    ...
    text: (
      <>
        ...
        same way military strength is stored up in the mass of the
        people—invisible in times of peace but always ready for use as a source
        of power. The attributes of the two trigrams are danger inside and
        obedience outside. This points to the nature of an army, which at the
    ...
    lines: [
      ...
      <>
        ...
        “corpse boy” is sitting in the wagon, or, in other words, that authority
        is not being exercised by the proper leaders but has been usurped by
        others. Perhaps the whole difficulty clears up if it is inferred that
        there has been an error in copying. The character fan, meaning “all,”
      ...
      <>
        ...
        In face of a superior enemy, with whom it would be hopeless to engage in
        battle, an orderly retreat is the only correct procedure, because it
      ...
      <>
        ...
        devastating the fields. This points to an enemy invasion. Energetic
      ...
      <>
        ...
        The war has ended successfully, victory is won, and the king divides
  ...
  8: {
    ...
    lines: [
      ...
      <>
        ...
        necessary, and they cleave to their ruler of their own volition. The
        same principle of freedom is valid for life in general. We should not
  ...
  9: {
    ...
    text: (
      <>
        ...
        breath of the Creative, and makes them grow dense, but as yet is not
        strong enough to turn them to rain. The hexagram presents a
    ...
    lines: [
      ...
      <>
        ...
        heed this hint from fate, hence there are annoying arguments like those
      ...
      <>
        ...
        powerful man, one should restrain him in such a way that right may
        prevail. Therein lies a danger so great that the threat of actual
      ...
      <>
        ...
        has been reached. This has come about through the accumulation of small
        ...
        persist in vaunting it—that would lead to danger. The dark power in the
        moon is strongest when the moon is almost full. When it is full and
  ...
  10: {
    ...
    text: (
      <>
        ...
        because it happens in good humor [Tui] and without presumption, so that
    ...
    lines: [
      ...
      <>
        ...
        from the bustle of life, seeks nothing, asks nothing of anyone, and is
  ...
  11: {
    ...
    text: (
      <>
        ...
        show favor to the lowly, and the lowly and inferior in their turn are
        well disposed toward the highly placed. There is an end to all feuds.
        <br />
        <br />
    ...
    lines: [
      ...
      <>
        ...
        for mutual advantage; instead, each man should do his duty. These are
      ...
      <>
        ...
        might induce melancholy, but it should not; it ought only to keep us
  ...
  12: {
    ...
    lines: [
      <>
        ...
        drawing another with him into retirement from public life. This is why
      ...
      <>
        ...
        certain. K'ung Fu-tzu says about this line: “Danger arises when a man
        feels secure in his position. Destruction threatens when a man seeks to
        preserve his worldly estate. Confusion develops when a man has put
        everything in order. Therefore the superior man does not forget danger
  ...
  13: {
    title: "13. T'ung Jên / Fellowship with Men ䷌",

    text: (
      <>
        The image of the upper trigram Ch’ien is heaven, and that of the lower,
        Li, is flame. It is the nature of fire to flame up to heaven. This gives
        the idea of fellowship. It is the second line that, by virtue of its
        central character, unites the five strong lines around it. This hexagram
        forms a complement to Shih, THE ARMY (7). In the latter, danger is
        within and obedience without—the character of a warlike army, which, in
        order to hold together, needs one strong man among the many who are
        weak. Here, clarity is within and strength without—the character of a
        peaceful union of men, which, in order to hold together, needs one
        yielding nature among many firm persons.
        <br />
        <br />
        <p>
          &nbsp;&nbsp;&nbsp;&nbsp;THE JUDGMENT
        ...
        needed—a man with clear, convincing, and inspiring aims and the strength
        to carry them out. (The inner trigram means clarity; the outer,
        strength.)
        <br />
        <br />
        <p>
    ...
    lines: [
      ...
      <>
        ...
        other, plans a secret ambush, and seeks to spy on his fellow from afar.
      ...
      <>
        ...
        Here the reconciliation that follows quarrel moves nearer. It is true
      ...
      <>
        ...
        true to each other, they allow nothing to separate them, and although it
  ...
  14: {
    ...
    text: (
      <>
        ...
        The two trigrams indicate that strength and clarity unite. Possession in
        ...
        favorable—a time of strength within, clarity and culture without. Power
        is expressing itself in a graceful and controlled way. This brings
        ...
        be administered properly. The sun brings both evil and good into the
    ...
    lines: [
      ...
      <>
        ...
        and in which one can journey far, means that there are at hand able
      ...
      <>
        ...
        descending from heaven, and all goes well. K'ung Fu-tzu says of this
        line:
        <br />
        <br />
  ...
  15: {
    ...
    text: (
      <>
        ...
        representative of heaven on earth. It dispenses the blessings of heaven,
        the clouds and rain that gather round its summit, and thereafter shines
        forth radiant with heavenly light. This shows what modesty is and how it
        ...
        appears in this hexagram as exalted, by being placed above the mountain.
        This shows how modesty functions in lowly, simple people: they are
        lifted up by it.
        <br />
        <br />
        <p>
        ...
        Here an effect that it took a long time to achieve, but that in the end
        seems easy of accomplishment and self-evident, is used as the image of
    ...
    lines: [
      ...
      <>
        ...
        abused nor the merits of the man in inferior place concealed. There are
        officials who indeed do not strive for prominence; they hide behind the
        letter of the ordinances, decline all responsibility, accept pay without
  ...
  16: {
    ...
    text: (
      <>
        ...
        movement that meets with devotion and therefore inspires enthusiasm,
        ...
        society: only such laws as are rooted in popular sentiment can be
        ...
        themselves felt. So too, music has power to ease tension within the
        heart and to loosen the grip of obscure emotions. The enthusiasm of the
        heart expresses itself involuntarily in a burst of song, in dance and
        ...
        <br />
        <br />
        These ideas are the final summation of Chinese culture. K'ung Fu-tzu has
    ...
    lines: [
      ...
      <>
        ...
        Perseverance in such conduct will bring good fortune. K'ung Fu-tzu says
        about this line:
        <br />
        <br />
        ...
        perceives the seeds and immediately takes action. He does not wait even
        a whole day. In the Book of Changes it is said: “Firm as a rock. Not a
  ...
  17: {
    ...
    text: (
      <>
        ...
        cunning, by conspiracy or by creating factions, he invariably arouses
        ...
        “Perseverance furthers”—that is, consistency in doing right—together
        with “No blame.” Just as we should not ask others to follow us unless
        this condition is fulfilled, so it is only under this condition that we
        ...
        it is the thunder in the middle of the lake that serves as the
        image—thunder in its winter rest, not thunder in motion. The idea of
        following in the sense of adaptation to the demands of the time grows
        out of this image. Thunder in the middle of the lake indicates times of
        darkness and rest. Similarly, a superior man, after being tirelessly
  ...
  18: {
    ...
    text: (
      <>
        ...
        breeding. This means decay. It has come about because the gentle
        indifference of the lower trigram has come together with the rigid
        ...
        freedom. Work toward improving conditions promises well, because it
        accords with the possibilities of the time. We must not recoil from work
        and danger—symbolized by crossing of the great water—but must take hold
        energetically. Success depends, however, on proper deliberation. This is
        expressed by the lines, “Before the starting point, three days. After
        the starting point, three days.” We must first know the causes of
        corruption before we can do away with them; hence it is necessary to be
        cautious during the time before the start. Then we must see to it that
        the new way is safely entered upon, so that a relapse may be avoided;
        therefore we must pay attention to the time after the start.
        Decisiveness and energy must take the place of the inertia and
        indifference that have led to decay, in order that the ending may be
        ...
        with debasing attitudes and fashions; they corrupt human society. To do
        away with this corruption, the superior man must regenerate society. His
        methods likewise must be derived from the two trigrams, but in such a
        way that their effects unfold in orderly sequence. The superior man must
    ...
    lines: [
      <>
        ...
        if a son were compensating for the decay his father allowed to creep in.
      ...
      <>
        ...
        the mistakes of the past. Now and then, as a result, minor discords and
      ...
      <>
        ...
        justified in letting the world go its own way and in refusing to enter
  ...
  22: {
    ...
    text: (
      <>
        ...
        thing; it is only the ornament and must therefore be used sparingly and
        only in little things. In the lower trigram of fire a yielding line
        comes between two strong lines and makes them beautiful, but the strong
        lines are the essential content and the weak line is the beautifying
        form. In the upper trigram of the mountain, the strong line takes the
        lead, so that here again the strong element must be regarded as the
        decisive factor. In nature we see in the sky the strong light of the
        sun; the life of the world depends on it. But this strong, essential
        thing is changed and given pleasing variety by the moon and the stars.
        In human affairs, aesthetic form comes into being when traditions exist
        that, strong and abiding like mountains, are made pleasing by a lucid
        beauty. By contemplating the forms existing in the heavens we come to
        understand time and its changing demands. Through contemplation of the
        forms existing in human society it becomes possible to shape the world.
        <br />
        <p>
          <br />
          &nbsp;&nbsp;&nbsp;&nbsp;THE IMAGE
    ...
    lines: [
      ...
      <>
        ...
        indicates simplicity. At first it may be disappointing to renounce
      ...
      <>
        ...
        nothing but magnificence and luxury, into the solitude of the heights.
  ...
  23: {
    ...
    lines: [
      ...
      <>
        ...
        one’s person; already there are dear indications, and rest is disturbed.
        Moreover, in this dangerous situation one is as yet without help or
        friendly advances from above or below. Extreme caution is necessary in
      ...
      <>
        ...
        just when the fruit falls to the ground that good sprouts anew from its
  ...
  24: {
    ...
    text: (
      <>
        ...
        time of the year—a custom that survives in the time of rest observed at
        the new year. In winter the life energy, symbolized by thunder, the
  ...
  27: {
    ...
    text: (
      <>
        This hexagram is a picture of an open mouth; above and below are the
        firm lines of the lips, and between them the opening. Starting with the
        ...
        life forces stir again, all things come into being anew. “He brings to
        perfection in the sign of Keeping Still”: thus in the early spring, when
        the seeds fall to earth, all things are made ready. This is an image of
        providing nourishment through movement and tranquillity. The superior
        man takes it as a pattern for the nourishment and cultivation of his
        character. Words are a movement going from within outward. Eating and
        drinking are movements from without inward. Both kinds of movement can
        be modified by tranquillity. For tranquillity keeps the words that come
    ...
    lines: [
      ...
      <>
        ...
        supported in a proper way by those whose duty and privilege it is to
      ...
      <>
        ...
        high position and striving to let his light shine forth. To do this he
  ...
  28: {
    ...
    text: (
      <>
        ...
        problem must be solved by gentle penetration to the meaning of the
        ...
        Extraordinary times when the great preponderates are like floodtimes
    ...
    lines: [
      ...
      <>
        ...
        root. This means an extraordinary reanimation of the processes of
        growth. In the same way, an extraordinary situation arises when an older
        man marries a young girl who suits him. Despite the unusualness of the
  ...
  30: {
    ...
    text: (
      <>
        ...
        something,” “to be conditioned,” “to depend or rest on something,” and
        also “brightness.” A dark line clings to two light lines, one above and
        one below—the image of an empty space between two strong lines, whereby
        the two strong lines are made bright. The trigram represents the middle
        daughter. The Creative has incorporated the central line of the
        Receptive, and thus Li develops. As an image, it is fire. Fire has no
        definite form but clings to the burning object and thus is bright. As
        water pours down from heaven, so fire flames up from the earth. While
        K’an means the soul shut within the body, Li stands for nature in its
        radiance.
        <br />
        <br />
        <p>
        ...
        <br />
        <br />
        Thus sun and moon cling to heaven, and grain, grass, and trees cling to
  ...
  31: {
    ...
    text: (
      <>
        ...
        Tui, the Joyous; the lower is Kên, Keeping Still. By its persistent,
        ...
        <br />
        <br />
        Just as the first part of the book I begins with the hexagrams of heaven
    ...
    lines: [
      <>
        ...
        toes. The idea of an influence is already present, but it is not
  ...
  33: {
    ...
    text: (
      <>
        ...
        advancing. In this case retreat is the right course, and it is through
        retreat that success is achieved. But success consists in being able to
        carry out the retreat correctly. Retreat is not to be confused with
        flight. Flight means saving oneself under any circumstances, whereas
        retreat is a sign of strength. We must be careful not to miss the right
        moment while we are in full possession of power and position. Then we
        shall be able to interpret the signs of the time before it is too late
        and to prepare for provisional retreat instead of being drawn into a
        desperate life-and-death struggle. Thus we do not simply abandon the
        field to the opponent; we make it difficult for him to advance by
    ...
    lines: [
      ...
      <>
        ...
        superior men that the latter cannot shake him off. And because he is in
  ...
  35: {
    ...
    text: (
      <>
        ...
        The light of the sun as it rises over the earth is by nature clear. The
        higher the sun rises, the more it emerges from the dark mists, spreading
        the pristine purity of its rays over an ever widening area. The real
    ...
    lines: [
      <>
        ...
        rebuff. Then the thing to do is simply to continue in what is right; in
        the end this will bring good fortune. It may be that we meet with no
      ...
      <>
        ...
        proceeding on the offensive may always be dangerous. In this way we
  ...
  37: {
    ...
    text: (
      <>
        This hexagram represents the laws obtaining within the family. The
        strong line at the top represents the father, the lowest the son. The
        strong line in the fifth place represents the husband, the yielding
        second line the wife. On the other hand, the two strong lines in the
        fifth and the third place represent two brothers, and the two weak lines
        correlated with them in the fourth and the second place stand for their
        respective wives. Thus all the connections and relationships within the
        family find their appropriate expression. Each individual line has the
        character according with its place. The fact that a strong line occupies
        the sixth place—where a weak line might be expected—indicates very
        clearly the strong leadership that must come from the head of the
        family. The line is to be considered here not in its quality as the
        sixth but in its quality as the top line. THE FAMILY shows the laws
        operative within the household that, transferred to outside life, keep
        the state and the world in order. The influence that goes out from
        within the family is represented by the symbol of the wind created by
        fire.
        <br />
        <br />
        <p>
        ...
        family—that between father and son, which is the relation of love, that
        between husband and wife, which is the relation of chaste conduct, and
        that between elder and younger brother, which is the relation of
        ...
        the form of deference. The family is society in embryo; it is the native
        soil on which performance of moral duty is made easy through natural
        affection, so that within a small circle a basis of moral practice is
        created, and this is later widened to include human relationships in
        general.
        <br />
        <p>
          <br />
        ...
        fire and issuing forth from it. This represents influence working from
        within outward. The same thing is needed in the regulation of the
        family. Here too the influence on others must proceed from one’s own
        ...
        conduct, just as the wind is made effective by its duration. Only firm
    ...
    lines: [
      <>
        ...
        we insist on order from the outset, occasions for remorse may arise—in
        general social life these are unavoidable—but the remorse always
      ...
      <>
        ...
        be he father, husband, or grown son. Her place is within the house.
        There, without having to look for them, she has great and important
        duties. She must attend to the nourishment of her family and to the food
        for the sacrifice. In this way she becomes the center of the social and
        religious life of the family, and her perseverance in this position
  ...
  39: {
    ...
    lines: [
      ...
      <>
        ...
        words, when he cannot act of his own volition but is duty bound to go
      ...
      <>
        ...
        family or as head of his kin. If he were to plunge recklessly into
      ...
      <>
        ...
        This too describes a situation that cannot be managed singlehanded. In
  ...
  40: {
    ...
    text: (
      <>
        ...
        conditions as soon as possible; this is the meaning of “the southwest.”
        These periods of sudden change have great importance. Just as rain
        relieves atmospheric tension, making all the buds burst open, so a time
        of deliverance from burdensome pressure has a liberating and stimulating
        effect on life. One thing is important, however: in such times we must
        not overdo our triumph. The point is not to push on farther than is
        necessary. Returning to the regular order of life as soon as deliverance
        is achieved brings good fortune. If there are any residual matters that
        ought to be attended to, it should be done as quickly as possible, so
        that a clean sweep is made and no retardations occur.
        <br />
        <p>
          <br />
          &nbsp;&nbsp;&nbsp;&nbsp;THE IMAGE
    ...
    lines: [
      ...
      <>
        ...
        bring disgrace upon himself. K'ung Fu-tzu says about this line:
        <br />
        <br />
      ...
      <>
        ...
        himself from such chance acquaintances with whom he has no inner
      ...
      <>
        ...
        forcibly removed, and this requires appropriate means. K'ung Fu-tzu says
        about this line:
        <br />
        <br />
  ...
  41: {
    ...
    text: (
      <>
        ...
        moisture. The mountain stands as the symbol of a stubborn strength that
  ...
  42: {
    ...
    text: (
      <>
        ...
        best use of the time. This time resembles that of the marriage of heaven
        and earth, when the earth partakes of the creative power of heaven,
        forming and bringing forth living beings. The time of INCREASE does not
        endure, therefore it must be utilized while it lasts.
        <br />
        <p>
          <br />
          &nbsp;&nbsp;&nbsp;&nbsp;THE IMAGE
        ...
        a man can note the way to self-increase and self-improvement. When he
    ...
    lines: [
      ...
      <>
        ...
        for it, that is, through receptivity to and love of the good. Thus the
  ...
  43: {
    ...
    text: (
      <>
        ...
        exist side by side—therefore fight without quarter is necessary if the
        good is to prevail.
        <br />
        <br />
        ...
        the sharp edges of the weapons of evil become dulled. For the same
        ...
        For all gathering is followed by dispersion. Therefore the superior man
        begins to distribute while he is accumulating. In the same way, in
    ...
    lines: [
      <>
        ...
        We feel inspired to press forward but resistance is still strong;
        therefore we ought to gauge our own strength and venture only so far as
      ...
      <>
        ...
        he dwells in the midst of difficulties as though they did not exist. If
      ...
      <>
        ...
        any participation in his vileness. He will of course be misjudged. It
  ...
  44: {
    ...
    text: (
      <>
        ...
        as dangerous and so lends him power. If he were resisted from the first,
  ...
  45: {
    ...
    text: (
      <>
        ...
        (8). In the latter, water is over the earth; here a lake is over the
        earth. But since the lake is a place where water collects, the idea of
        ...
        bring about the gathering together, whereas in the former case one
        strong line (the fifth) stands in the midst of weak lines.
        <br />
        <br />
        <p>
          &nbsp;&nbsp;&nbsp;&nbsp;THE JUDGMENT
        ...
        made. In the secular sphere likewise there is need of great deeds in the
        time of GATHERING TOGETHER.
        <br />
        <p>
          <br />
          &nbsp;&nbsp;&nbsp;&nbsp;THE IMAGE
  ...
  47: {
    ...
    text: (
      <>
        ...
        two light lines; below, a light line is hemmed in between two dark ones.
    ...
    lines: [
      ...
      <>
        ...
        Therefore it is important to meet these obstructions in the invisible
      ...
      <>
        ...
        fresh disappointment, that his wife is not there. K'ung Fu-tzu says
        about this line:
        <br />
        <br />
  ...
  48: {
    ...
    text: (
      <>
        ...
        the life of man with its needs remains eternally the same—this cannot be
        changed. Life is also inexhaustible. It grows neither less nor more; it
        exists for one and for all. The generations come and go, and all enjoy
        life in its inexhaustible abundance.
        <br />
        <br />
        ...
        convention—a partial education of this sort is as bad as none—or he may
        suddenly collapse and neglect his self-development.
        <br />
        <p>
          <br />
          &nbsp;&nbsp;&nbsp;&nbsp;THE IMAGE
    ...
    lines: [
      ...
      <>
        ...
        “good fortune” is left out here. The all-important thing about a well is
        that its water be drawn. The best water is only a potentiality for
  ...
  49: {
    ...
    text: (
      <>
        ...
        From this the word is carried over to apply to the “moltings” in
        political life, the great revolutions connected with changes of
        governments.
        <br />
        <br />
        The two trigrams making up the hexagram are the same two that appear in
        K’uei, OPPOSITION (38), that is, the two younger daughters, Li and Tui.
        But while there the elder of the two daughters is above, and what
        results is essentially only an opposition of tendencies, here the
    ...
    lines: [
      ...
      <>
        ...
        When we have tried in every way to bring about reforms, but without
        ...
        requisite abilities and who possesses public confidence. To such a man
        we may well turn. This brings good fortune and is not a mistake. The
      ...
      <>
        ...
        among the inferior people. In conformity with the new order, they
  ...
  50: {
    ...
    text: (
      <>
        ...
        head of the family served the food from the ting into the bowls of the
        guests.
        <br />
        <br />
        THE WELL (48) likewise has the secondary meaning of giving nourishment,
        but rather more in relation to the people. The ting, as a utensil
        ...
        fire bums above. It is the same in human life; there is in man likewise
    ...
    lines: [
      <>
        ...
        but because she has a son she comes to be honored.
        <br />
        <br />
  ...
  51: {
    ...
    text: (
      <>
        ...
        men—a profound inner seriousness from which all outer terrors glance off
        harmlessly.
        <br />
        <p>
          <br />
  ...
  53: {
    ...
    text: (
      <>
        ...
        also point to this: within is tranquility, which guards against
    ...
    lines: [
      ...
      <>
        ...
        thereby. However, this is not at all necessary; it is only the result of
      ...
      <>
        ...
        in the course of its development, often brings him into inappropriate
        situations, in which he finds it difficult to hold his own without
      ...
      <>
        ...
        isolated. One is misjudged by the very person on whom one is
        dependent—the woman by her husband, the official by his superior. This
        is the work of deceitful persons who have wormed their way in. The
        result is that relationships remain sterile, and nothing is
  ...
  55: {
    ...
    text: (
      <>
        ...
        decline that must follow. But such sadness does not befit him. Only a
        ...
        (21), in which thunder and lightning similarly appear together, but in
        the reverse order. In BITING THROUGH, laws are laid down; here they are
  ...
  57: {
    ...
    lines: [
      ...
      <>
        ...
        entirely new point of departure must be set up, whereas here it is only
        a question of reforms. The beginning has not been good, but the moment
        has been reached when a new direction can be taken. Change and
        improvement are called for. Such steps must be undertaken with
        steadfastness, that is, with a firm and correct attitude of mind; then
        they will succeed, and remorse will disappear. But it must be remembered
        that such improvements require careful consideration. Before a change is
        made, it must be pondered over again and again. After the change is
  ...
  59: {
    ...
    text: (
      <>
        ...
        that have been separated, as water collects in lakes upon the earth.
        ...
        articulation of family and state, was the means employed by the great
        rulers to unite men. The sacred music and the splendor of the ceremonies
        aroused a strong tide of emotion that was shared by all hearts in
        ...
        common concentration on this goal, all barriers dissolve, just as, when
        a boat is crossing a great stream, all hands must unite in a joint task.
        <br />
        <br />
    ...
    lines: [
      ...
      <>
        ...
        its crisis in a dissolving sweat, so a great and stimulating idea is a
  ...
  60: {
    ...
    lines: [
      <>
        ...
        in preparing the way for momentous things. Concerning this, K'ung Fu-tzu
        says:
        <br />
        <br />
        “Where disorder develops, words are the first steps. If the prince is
        not discreet, he loses his servant. If the servant is not discreet, he
  ...
  61: {
    ...
    text: (
      <>
        ...
        <br />
        <br />
        The character fu (“truth”) is actually the picture of a bird’s foot over
        a fledgling. It suggests the idea of brooding. An egg is hollow. The
        light-giving power must work to quicken it from outside, but there must
        be a germ of life within, if life is to be awakened. Far-reaching
        ...
        <br />
        <br />
        But it is important to understand upon what the force of inner truth
    ...
    lines: [
      ...
      <>
        ...
        effect would only destroy the possibility of producing it. K'ung Fu-tzu
      ...
      <>
        ...
        between joy and sorrow. Rejoicing to high heaven, then sad unto
        death—this is the fate of those who depend upon an inner accord with
        other persons whom they love. Here we have only the statement of the law
      ...
      <>
        ...
        light from the sun. However, this requires a certain humility, like that
  ...
  62: {
    ...
    text: (
      <>
        ...
        strong lines preponderate and are within, inclosed between weak lines at
        the top and bottom, the present hexagram has weak lines preponderating,
        though here again they are on the outside, the strong lines being
        within. This indeed is the basis of the exceptional situation indicated
        by the hexagram. When strong lines are outside, we have the hexagram I,
        PROVIDING NOURISHMENT (27), or Chung Fu, INNER TRUTH (61); neither
        represents an exceptional state. When strong elements within
        preponderate, they necessarily enforce their will. This creates struggle
        and exceptional conditions in general. But in the present hexagram it is
        the weak element that perforce must mediate with the outside world. If a
        man occupies a position of authority for which he is by nature really
        ...
        is brought by a bird. In Ta Kuo, PREPONDERANCE OF THE GREAT (28), the
    ...
    lines: [
      ...
      <>
        ...
        alone and has no helpers. In such times a man must seek out helpers with
        whose aid he can carry out the task. But these helpers must be modestly
        sought out in the retirement to which they have withdrawn. It is not
  ...
  63: {
    ...
    text: (
      <>
        ...
        confusion to order is completed, and everything is in its proper place
        even in particulars. The strong lines are in the strong places, the weak
        lines in the weak places. This is a very favorable outlook, yet it gives
        reason for thought. For it is just when perfect equilibrium has been
        ...
        nature, and thus suddenly there arises again the hexagram P’i,
        STANDSTILL (12).
        <br />
        <br />
        ...
        attitude. Everything proceeds as if of its own accord, and this can all
        too easily tempt us to relax and let things take their course without
        ...
        inescapable law. He who understands it is in position to avoid its
        effects by dint of unremitting perseverance and caution.
        <br />
        <p>
          <br />
          &nbsp;&nbsp;&nbsp;&nbsp;THE IMAGE
        ...
        evaporates into the air. These elements here brought into relation and
    ...
    lines: [
      ...
      <>
        ...
        the outset any chance of success. This holds true in small as well as in
